...
export const SEARCH_PAGES: SearchPage[] = [
  ...
  },
  {
    ...
    ], related: ["/workshop", "/ai-automation-south-africa", "/resources", "/contact"],
  },
  {
  ...
  },
  {
    ...
    images: [
      { src: "/images/stories/operators-intensive-session.jpg", alt: "Owners working through the first Operator Intensive at WeWork Rosebank", width: 390, height: 292, caption: "The first Operator Intensive, WeWork Rosebank." },
    ...
    sections: [
      { title: "The business", paragraphs: ["MNE Waste handles waste collection and disposal, including medical waste for healthcare facilities. The work runs on trucks, drivers, compliance and municipal contracts — an operation where the owner ends up holding every detail, and every question comes back to him."] },
  ...
  },
  {
    ...
    sections: [
      { title: "The business", paragraphs: ["Running a beauty and cosmetics brand means taking orders, keeping inventory straight, managing client bookings and producing a steady stream of brand content — much of it repetitive, and most of it landing on the owner."] },
  ...
  },
  {
    ...
    intro: "When every follow-up waits for the owner, leads cool while the business is busy. We build a follow-up system from your knowledge — what you sell, how you talk, what you promised in the last conversation — so the next message is drafted in minutes and a person approves it.",
    sections: [

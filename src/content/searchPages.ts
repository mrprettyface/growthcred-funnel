...
export const SEARCH_PAGES: SearchPage[] = [
  ...
  },
  {
    ...
    related: ["/guides/choose-ai-tools-small-business", "/guides/ai-challenges-south-africa", "/ai-proposal-automation", "/ai-follow-up-automation", "/ai-admin-automation", "/guides/how-we-work-first-30-days", "/call", "/data-and-security"],
  },
  {
  ...
  },
  {
    ...
    related: ["/guides/ai-business-proposals-faster", "/guides/choose-ai-tools-small-business", "/guides/ai-challenges-south-africa", "/guides/ai-training-cost-south-africa", "/guides/business-brain", "/guides/ai-proposals-and-follow-ups", "/guides/ai-training-vs-automation", "/guides/ai-automation-cost-south-africa", "/tools/admin-time-calculator", "/stories"],
  },
  {
  ...
  {
    path: "/guides/ai-business-proposals-faster", kind: "guide", published: "2026-09-25",
    title: "How to Write Business Proposals Faster With AI | GrowthCred",
    description: "A practical AI proposal workflow built from your business brief, discovery notes and approved commercial rules—not a generic write-my-proposal prompt.",
    heading: "Your proposal problem is not writing. It is rebuilding the brief every time.",
    intro: "A blank page makes every proposal feel custom, but much of the work is repeated: finding the service description, reconstructing the discovery call, checking commercial rules and rebuilding the same structure. AI helps when it assembles those approved inputs. It creates risk when it is asked to invent what is missing.",
    sections: [
      { title: "The contrarian view: stop trying to write faster", paragraphs: ["Most proposal advice starts with a better prompt. That is too late. If the scope lives in meeting notes, prices live in a spreadsheet and the founder's tone lives only in their head, the draft will still wait for someone to assemble the truth.", "The useful target is not faster typing. It is a proposal system that gives a drafter—human or AI—the same approved inputs every time, then makes uncertainty visible before anything reaches a prospect."] },
      { title: "Build the four proposal assets once", paragraphs: ["Keep reusable business knowledge separate from client-specific information. That makes maintenance easier and reduces the chance that one customer's confidential detail leaks into another proposal."], items: [
        "Business brief: positioning, services, tone, proof you are authorised to use and the owner of each fact.",
        "Discovery record: the prospect's problem, desired outcome, constraints, stakeholders and exact next step.",
        "Commercial rules: approved pricing source, discount authority, standard exclusions, payment terms and validity period.",
        "Proposal structure: headings, required sections, review checklist and examples of approved final work.",
      ] },
      { title: "Use a source-bound briefing", paragraphs: ["Ask the tool to use only the supplied business brief, discovery record and commercial rules. Tell it to mark every missing fact as a question and to separate assumptions from confirmed scope. Specify the required sections and the person who will review the result.", "A useful instruction is: prepare a first draft from these sources; do not invent prices, dates, client facts, proof or commitments; list missing information before the draft; cite the supplied source beside every commercial figure for the reviewer."] },
      { title: "Review the proposal where it can actually hurt", paragraphs: ["Fluent wording is not the main risk. Review the places where a polished mistake changes the deal: recipient, scope, exclusions, quantities, calculations, dates, dependencies, intellectual property, payment terms and the next step.", "Recalculate totals outside the generated prose. Confirm that every testimonial or result is permissioned. Remove internal notes and unresolved questions. Make one person responsible for final approval and keep that approved version as a future example."], items: [
        "Can every price and commercial term be traced to an approved source?",
        "Does the scope match what the prospect actually asked for?",
        "Are exclusions and client responsibilities explicit?",
        "Has information from another customer been removed?",
        "Does the proposed next step match the conversation?",
      ] },
      { title: "Measure turnaround without fooling yourself", paragraphs: ["Record the full baseline: finding inputs, drafting, corrections, review and sending. Then test the new workflow on several comparable proposals, including one with incomplete notes. A draft that appears quickly but needs a long forensic review has not solved the bottleneck.", "Track elapsed turnaround, hands-on time, correction time and the number of missing-input questions. Keep expected improvements separate from measured results. Faster delivery can improve responsiveness; it does not guarantee that a prospect will buy."] },
      { title: "Build it yourself or have it implemented", mark: "diy", paragraphs: ["Choose the one-day workshop if you want to create your business brief, map the proposal inputs and practise the first source-bound draft yourself. Bring a fictional or properly redacted example and your approved commercial rules.", "Apply for implementation if proposals cross several people or tools, pricing logic needs controlled sources, or the workflow needs intake, document generation and approval steps. GrowthCred scopes, tests and hands over the workflow; your business retains responsibility for every proposal it sends."] },
    ],
    faq: [
      { q: "Can AI write the whole proposal for me?", a: "It can prepare a first draft from approved inputs. A person still needs to confirm the client facts, scope, figures, terms, exclusions and commitments before the proposal is sent." },
      { q: "What should go into the business brief?", a: "Include your positioning, services, tone, approved proof and the owner of each fact. Keep client-specific notes and confidential information in a separate discovery record." },
      { q: "How do I know whether the workflow is faster?", a: "Measure the complete task before and after: input gathering, drafting, corrections, review and sending. Test several comparable proposals and count missing-input cases as well as minutes." },
      { q: "Should I attend the workshop or apply for implementation?", a: "Use the workshop to build and understand your first proposal workflow. Apply for implementation if the process crosses people or systems and needs controlled inputs, approval steps, testing and handover." },
    ],
    ctas: [{ to: "/call", label: "Apply for implementation" }, { to: "/workshop", label: "Build it in the workshop" }],
    related: ["/ai-proposal-automation", "/guides/business-brain", "/guides/ai-proposals-and-follow-ups", "/guides/choose-ai-tools-small-business", "/workshop", "/call"],
  },
  {
    path: "/guides/choose-ai-tools-small-business", kind: "guide", published: "2026-09-25",
    title: "How to Choose AI Tools for Small Business | GrowthCred",
    description: "Skip the best-AI-tools list. Score your bottleneck, choose the smallest tool category that fits and prove it on ten real examples before expanding.",
    heading: "The best AI tool list is already out of date. Use a buying test instead.",
    intro: "Tools change names, prices and features faster than most businesses can implement them. A durable decision starts with one measured bottleneck, then chooses the smallest tool category that can improve it without creating a larger review, security or maintenance burden.",
    sections: [
      { title: "The contrarian view: do not start with the tool", paragraphs: ["A tool demo shows what the product can do under ideal conditions. It does not show whether your team has usable inputs, whether the workflow has settled or who will handle exceptions. Buying before answering those questions turns software into another unfinished project.", "Start with the task you want to remove or improve. Name its trigger, inputs, steps, output, reviewer and failure cases. If the process changes every week, stabilise it before automating it."] },
      { title: "Score the bottleneck before shopping", paragraphs: ["Track a normal week and list repeated tasks. For each one, estimate frequency, hands-on minutes, delay created, correction rate and consequence when it is late or wrong. Do not automatically choose the longest task: a short task that blocks every sale may matter more."], items: [
      ...
      { title: "Choose the smallest tool category", paragraphs: ["Use an AI assistant when a person supplies the context and reviews each draft. Use workflow automation when the task moves predictable information between systems. Use a system of record when the real problem is that nobody knows which customer, task or document is current.", "Many businesses need the system of record fixed before they need more AI. Automating scattered or contradictory information produces faster confusion, not leverage."], items: [
      ...
      { title: "Use this six-question buying test", paragraphs: ["Named products can fit more than one category, and their terms change. Evaluate the current documentation and contract for the exact plan you would use rather than relying on an old comparison article."], items: [
      ...
      { title: "Run a ten-example pilot", paragraphs: ["Choose ten representative examples: ordinary cases, incomplete inputs and at least one awkward exception. Record the old task first. Then configure the smallest viable workflow and measure setup, execution, corrections and review.", "Pass the pilot only if the new process reduces total effort or delay without weakening quality or control. A fast output that increases rework, hides failures or depends on one enthusiast is not a successful implementation."], items: [
      ...
      { title: "Build it yourself or have it implemented", mark: "diy", paragraphs: ["Choose the workshop if you want to map your bottleneck, build the first controlled workflow and learn how to assess the output yourself. Do not subscribe to a stack of tools before you know what the task needs.", "Apply for implementation when the workflow crosses accounts, permissions or systems, or when monitoring and exception handling need to be designed. GrowthCred assesses compatibility before promising an integration and scopes third-party costs separately."] },
    ],
    faq: [
      { q: "Which AI tool is best for a small business?", a: "There is no universal best tool. The right choice is the smallest tool category that improves your highest-value repeatable task and passes a pilot using your real workflow." },
      { q: "Should I buy several tools at once?", a: "Usually not. Prove one workflow first. Multiple subscriptions create more setup, permissions, data movement and maintenance before you know whether the first process works." },
      { q: "How many examples should I test?", a: "Ten is a practical starting set for this guide: include ordinary cases, incomplete inputs and awkward exceptions. It is a pilot design, not a statistical guarantee." },
      { q: "When do I need implementation help?", a: "Consider implementation when a workflow crosses systems, requires permissions, sends external messages or needs monitoring and exception handling. A simple reviewed drafting task may be suitable for the workshop." },
    ],
    ctas: [{ to: "/call", label: "Apply for implementation" }, { to: "/workshop", label: "Build it in the workshop" }],
    sources: [
      { label: "n8n documentation: workflows, integrations and deployment choices", href: "https://docs.n8n.io/" },
      { label: "n8n documentation: security audit and configuration risks", href: "https://docs.n8n.io/hosting/securing/security-audit/" },
    ],
    related: ["/tools/admin-time-calculator", "/guides/ai-training-vs-automation", "/ai-admin-automation", "/guides/ai-business-proposals-faster", "/workshop", "/call"],
  },
  {
    path: "/guides/ai-challenges-south-africa", kind: "guide", published: "2026-09-25",
    title: "AI Challenges for South African Businesses | GrowthCred",
    description: "A South African AI implementation guide covering POPIA, mobile-first workflows, resilience, skills and professional review without imported assumptions.",
    heading: "South Africa does not have an AI problem. It has an imported-workflow problem.",
    intro: "Buying the same tool as a company in San Francisco does not give you the same operating system. South African businesses need workflows that reflect their data duties, customer channels, infrastructure, team capacity and professional obligations. The fix is adaptation, not a bigger tool stack.",
    sections: [
      { title: "The contrarian view: local context is the implementation", paragraphs: ["An AI strategy often fails before the model does. The wrong information is allowed into the tool, customers are pushed into a channel they do not use, nobody owns exceptions and a foreign template is mistaken for a local operating process.", "Do not ask whether South Africa is ahead or behind. Ask whether one workflow fits your customers, information, people and controls. A small system that survives normal operating conditions is more valuable than an impressive demo that depends on perfect inputs."] },
      { title: "POPIA: paid is not the same as compliant", paragraphs: ["The useful distinction is not free AI versus paid AI. Before personal information enters any service, the responsible party still needs a lawful purpose, appropriate minimisation and safeguards, and clarity about operators, contracts, retention and any cross-border processing. A subscription badge does not answer those questions.", "Map the information before choosing the tool: what fields are needed, whose data it is, why the task needs it, where it travels, who can access it, how long it remains and how a person can correct or remove it. Use fictional or properly redacted examples until your organisation approves the real workflow."] },
      { title: "Mobile-first does not mean message everyone", paragraphs: ["Statistics South Africa reported that 85.6% of households had access to some form of internet in 2025. That broad access does not mean every customer wants another portal or has fixed home connectivity. Design the customer step around the channel your customers actually use, then provide an alternative path.", "For WhatsApp or any messaging channel, use an approved business route, obtain the permissions your use case requires, limit what appears in messages, provide human escalation and monitor delivery failures. Automating a poor or unwanted message only makes the irritation arrive faster."] },
      { title: "Resilience: stop designing around an outdated headline", paragraphs: ["By 4 September 2026, Eskom reported 476 consecutive days without loadshedding. It is no longer accurate to present national rotational loadshedding as the defining current barrier to business AI. Local outages, mobile connectivity, provider downtime and broken integrations still happen, so resilience remains an operating requirement rather than a marketing slogan.", "Define what happens when a service is unavailable: queue or pause the action, show the failure to an owner, prevent duplicates, keep a manual route and reconcile when service returns. Do not claim a cloud model works offline unless the provider's current documentation explicitly says the required function does."] },
      { title: "Skills: map the process before hiring the specialist", paragraphs: ["A business does not need an AI engineer for every drafting or routing problem. It does need someone who understands the current work, can define a good output and owns the review. Start there, then choose the delivery level the workflow genuinely requires.", "A workshop can suit a bounded, browser-based task the team wants to operate. A specialist implementation is more appropriate when data crosses systems, access controls matter, failure handling is consequential or the workflow needs ongoing monitoring. No-code reduces coding; it does not remove architecture, security or maintenance responsibility."] },
      { title: "Keep AI around the expert work", paragraphs: ["Finance and legal professionals illustrate the rule. AI can help collect supplied facts, prepare summaries, organise documents and draft communications. The authorised professional still verifies figures, sources, legal propositions, advice, deadlines and customer-impacting decisions.", "The SARB and FSCA identify operational opportunity alongside privacy, bias, explainability, governance and skills constraints in financial services. The right response is not to avoid AI or hand it the decision. It is to design a controlled preparation-and-review workflow."] },
      { title: "A South African readiness check", paragraphs: ["Before subscribing or connecting a customer channel, answer these questions for one workflow.", "Measure the current task first: elapsed time, hands-on effort, correction time, failures and customer delay. Use the same measures during the pilot so a polished demo cannot hide a worse operating process."], items: [
        "Work: which repeated task and measurable delay are we addressing?",
        "Information: what is necessary, where may it go and what must be redacted?",
        "Channel: where does the customer or employee already complete this step?",
        "Control: who reviews the output and which actions are prohibited?",
        "Resilience: how do we detect failure, pause safely and recover without duplicates?",
        "Ownership: who maintains the sources, permissions, vendor terms and test cases?",
      ] },
      { title: "Build it yourself or have it implemented", mark: "diy", paragraphs: ["Choose the workshop when you want to map one local workflow, practise on safe examples and leave with a repeatable method your team understands. The workshop does not certify legal or POPIA compliance.", "Apply for implementation when the workflow crosses tools or customer channels, uses approved business data, or needs permissions, monitoring and a tested fallback. Bring your legal, regulatory and internal requirements to scoping; GrowthCred does not replace your professional advisers."] },
    ],
    faq: [
      { q: "Does a paid AI plan make a workflow POPIA compliant?", a: "No. Review purpose, necessity, safeguards, operators, contracts, retention, access and cross-border processing for the actual workflow. Obtain appropriate professional advice for your obligations." },
      { q: "Should every South African business automate WhatsApp?", a: "No. Use the channel your customers actually use and an approved business route. Obtain the required permissions, limit message content, provide human escalation and keep another route for delivery failures or customer preference." },
      { q: "Is loadshedding still the main AI challenge?", a: "Eskom reported 476 consecutive days without loadshedding by 4 September 2026. Resilience still matters for local outages, connectivity, provider downtime and integration failures, but national loadshedding should not be treated as the defining current barrier." },
      { q: "Do we need an AI engineer?", a: "Not for every task. Start with a process owner and a bounded workflow. Bring in implementation expertise when data crosses systems, permissions matter, failures are consequential or ongoing monitoring is required." },
    ],
    ctas: [{ to: "/call", label: "Apply for implementation" }, { to: "/workshop", label: "Build it in the workshop" }],
    sources: [
      { label: "Information Regulator: POPIA security safeguards and operator responsibilities", href: "https://inforegulator.org.za/wp-content/uploads/2025/05/POPIA-document-gazz.pdf" },
      { label: "Statistics South Africa: General Household Survey 2025", href: "https://www.statssa.gov.za/publications/P0318/MEDIA%20RELEASE%20-%20%20GHS%202025%20.pdf" },
      { label: "Eskom: 2026 winter demand and system reliability update", href: "https://www.eskom.co.za/eskom-fully-meets-2026-winter-demand-eaf-remains-at-its-highest-level-since-2020-67-79-and-diesel-expenditure-declines-by-r4-84-billion-or-81-64-to-deliver-energy-security/" },
      { label: "SARB & FSCA: Artificial Intelligence in the South African Financial Sector", href: "https://www.resbank.co.za/en/home/publications/publication-detail-pages/prudential-authority/pa-public-awareness/Communication/2025/AI-in-the-South-African-Financial-Sector" },
    ],
    related: ["/data-and-security", "/ai-for-financial-services", "/ai-for-law-firms", "/guides/choose-ai-tools-small-business", "/workshop", "/call"],
  },
  {
  ...
  },
  {
    ...
    related: ["/guides/ai-business-proposals-faster", "/guides/ai-proposals-and-follow-ups", "/ai-follow-up-automation", "/stories", "/call"],
  },
  {
  ...
  },
  {
    ...
    related: ["/guides/choose-ai-tools-small-business", "/guides/admin-assistant-vs-ai-automation", "/tools/admin-time-calculator", "/ai-automation-south-africa", "/call"],
  },
  {
  ...
  },
  {
    ...
    related: ["/guides/ai-challenges-south-africa", "/guides/how-we-work-first-30-days", "/data-and-security", "/workshop", "/call"],
  },
  {
  ...
  },
  {
    ...
    related: ["/guides/ai-challenges-south-africa", "/privacy", "/contact", "/guides/how-we-work-first-30-days", "/call"],
  },
  {

  ...
  return <>
    <Section dark className="pt-10 md:pt-16">
      ...
      <div className="max-w-[860px]">
        ...
        {(page.kind==='guide'||page.kind==='story')&&<p className="mt-6 text-sm text-cream/55 [&_a]:text-cream">By <Link to="/about">Phila Ngwenya</Link> · {page.published?'Published':'Reviewed'} <time dateTime={page.published??REVIEWED}>{longDate(page.published??REVIEWED)}</time></p>}
      </div>
    ...
    <Section>
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,760px)_1fr]">
        <article className="min-w-0 space-y-10">
          ...
          {(page.kind==='guide'||page.kind==='story')&&<AuthorBox/>}

    ...
    <Section>
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,760px)_1fr]">
        <article className="min-w-0 space-y-10">
          ...
          {page.sources&&<section id="sources" className="scroll-mt-28"><h2 className="text-2xl md:text-3xl">Sources behind this page</h2><p className="mt-4 max-w-[70ch] leading-relaxed text-ink">Market figures are evidence of demand and risk, not GrowthCred client results. International legal research is labelled by market in the source itself and is used directionally.</p><ul className="mt-5 list-disc space-y-3 pl-6 text-ink">{page.sources.map(source=><li key={source.href}><a href={source.href} target="_blank" rel="noopener noreferrer">{source.label}</a></li>)}</ul></section>}

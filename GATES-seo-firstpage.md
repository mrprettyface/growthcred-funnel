...
OWNS: docs/search/HUMAN-LAYER.md, scripts/verify-human-layer.mjs, src/content/searchPages.ts, src/components/PageScenes.tsx, src/pages/SearchPage.tsx, src/seo/routes.ts, src/components/Layout.tsx, src/lib/supabase.ts, src/App.tsx, src/pages/Contact.tsx, src/components/ContactForm.tsx, public/.htaccess, public/_headers, scripts/verify-seo-onpage.mjs, scripts/verify-bundle-budget.mjs, scripts/verify-hosts-reposition.mjs
...
- [x] S1: the site builds, type-checks and prerenders every page
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/PhilaNgwenya/Projects/growthcred-funnel; path=d31f0ce6dc1c/18 entries; output=✓ built in 465ms | Prerendered 37 complete pages; 43 route documents generated.
...
- [x] S4: page speed budget holds; supabase-js stays off the critical path
  ...
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/PhilaNgwenya/Projects/growthcred-funnel; path=d31f0ce6dc1c/18 entries; output=bundle budget passed: main chunk 63683 B gz (≤ 70000), up-front total 142911 B gz (≤ 150000); supabase-js loads on demand.
...
- [x] S9: every content page shows first-hand evidence or is queued for Phila's input; every article names its author and date
  CHECK: node scripts/verify-human-layer.mjs
  EXPECT: /human layer verification passed/
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/Users/PhilaNgwenya/Projects/growthcred-funnel; path=d31f0ce6dc1c/18 entries; output=human layer verification passed: 13 pages carry first-hand evidence; 12 await Phila's input (/workshop, /guides/ai-training-cost-south-africa, /guides/business-brain, /guides/ai-proposals-and-follow-ups, /guides/ai-training-vs-automation, /

...
for(const [route,status,type] of [['/',200,'text/html'],['/ai-training-south-africa',200,'text/html'],['/resources',200,'text/html'],['/workshop',200,'text/html'],['/contact',200,'text/html'],['/robots.txt',200,'text/plain'],['/sitemap.xml',200,'xml'],['/checkout',200,'text/html'],['/missing-search-check-page',404,'text/html'],['/guides/missing-search-check-page',404,'text/html']]){
...
for(const [route,target] of [['/agency?source=test','/ai-automation-south-africa?source=test'],['/class','/webinar'],['/webinar-plain','/webinar'],['/resources/','/resources'],['/resources.html','/resources'],['/index.html','/']]){

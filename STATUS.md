...
> `/ai-implementation-guide`) opens about a second after arrival on
> desktop and after 8 s or 25% scroll on phones (Phila, 26 Sep), never on form/checkout pages, and rests 14 days once closed.
